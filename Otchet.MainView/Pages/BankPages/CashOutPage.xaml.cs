...
public partial class CashOutPage
{
    ...
    {
       _bankRepository.WithDraw(((Bank)CbBank.SelectedItem).Id, decimal.Parse(OneDollarIs.Text),
            (UsdRb.IsChecked == true || TjsRb.IsChecked == false), decimal.Parse(Money.Text),((Client)Clients.SelectedItem).Id);
    }
